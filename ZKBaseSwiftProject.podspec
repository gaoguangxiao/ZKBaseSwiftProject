...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZKBaseSwiftProject.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/小修/ZKBaseSwiftProject'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '小修' => 'gaoguangxiao125@sina.com' }
  s.source           = { :git => 'https://github.com/小修/ZKBaseSwiftProject.git', :tag => s.version.to_s }
